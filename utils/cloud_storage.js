...
const storage = new Storage({
    projectId: "kotlin-delivery-e69a3",//NOMBRE DE LA BASE DE DATOS
    keyFilename: './serviceAccountKey.json'//LLAVE DE LA CARPETA COMO LO LLAME
});

const bucket = storage.bucket("gs://kotlin-delivery-e69a3.appspot.com/");//URL DONDE APUNTAMOS APRA GUARDAR LAS IMAGENES COPIAR EL CODIGO DE LA BASE DE DATOS
